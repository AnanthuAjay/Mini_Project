...
var drop_down = document.querySelector(".login-options");
var drop_down_status = false;
var admin_login = document.getElementById("admin-login");
var org_login = document.getElementById("Organization-login");
